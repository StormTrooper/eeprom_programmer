/*
   ...
   This program is made to read/program Winbond W27c256
...
#if  !defined (VERIFY)  && !defined (READ) && !defined (WRITE) && !defined (ERASE) && !defined (CHECKBLANK)
  Serial.println( "Select mode!\n" );
  while (1) {}
#endif


#ifdef Chip W27C512       //64k x 8. Can r/w/erase 16k chunks
  count = 32;
#endif

#ifdef Chip 27C256        //32k x 8  r/w/erase the whole chip
  count = 128;
#endif
...
#ifdef CHECKBLANK
  Serial.println("Blank check EEPROM");
  BlankCheck();
#endif
...
void Read() {
  ...
  for (int y = 0; y < count; y++) {                 // Loop 8192/256 = 32  times to read 8K of memory
